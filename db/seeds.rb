User.create!(name:"Matsuoka Tamotsu");
User.create!(name:"Noguchi Cho");
User.create!(name:"Nakamoto Kyoko");
User.create!(name:"Okimoto Haru");
User.create!(name:"Kaya Yoshiyuki");
User.create!(name:"Nii Shigeru");
